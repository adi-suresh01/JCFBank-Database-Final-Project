1) Developed a full-stack project involving the use of real time data, helping the user to create a bank account and use features such as transaction payments, investments etc. \n
